import { BadRequestException, Body, Controller, Delete, Get, Put, Query } from '@nestjs/common';
...
export class UsersController {
    ...
    async removeUser(@Body() body: { userRef: string }) {
        if (!body?.userRef) throw new BadRequestException('Missing userRef parameter');
